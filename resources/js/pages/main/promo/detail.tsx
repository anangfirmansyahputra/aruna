  ...
  return (
    <>
      <Head title={promo[`${lang}_title`]}>
        ...
        <meta property="og:type" content="promos" />
        <meta property="og:title" content={promo[`${lang}_title`]} />
        {/* <meta
        ...
        <meta
          property="og:url"
          content={`${app_url}/promo/${promo[`${lang}_slug`]}`}
        />
        <meta property="og:site_name" content="Nama Website" />

        {/* Meta Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={promo[`${lang}_title`]} />
        {/* <meta
          name="twitter:description"
          content={article[`${lang}_meta_description`]}
        /> */}
        <meta name="twitter:image" content={promo.image_url} />

        {/* Canonical URL */}
        <link
          rel="canonical"
          href={`${app_url}/promo/${promo[`${lang}_slug`]}`}
        />
      </Head>
      <MainLayout>
