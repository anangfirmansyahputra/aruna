  ...
  return (
    <Link href={`/products/${product.translations[0].slug}`}>
      <div className="group">
        ...
        />
        <h3 className="text-black text-lg md:text-xl font-semibold mt-4">
          {product.translations[0]?.name}
        </h3>
        <p className="mt-1 text-[#777777] text-sm md:text-base">
          {product.translations[0]?.meta_descriptions}
        </p>

        <div className="md:flex hidden items-center mt-4 text-base text-[#777777] group-hover:text-primary transition-colors">
          Selengkapnya
